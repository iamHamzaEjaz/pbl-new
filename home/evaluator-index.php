...
<?php
 ...
 $sqlcounNAme = "SELECT count(grp_id) as total FROM assign_projects
 where e_id=$eid  ";
...
<div class="card-block">
<h5>Remaining <small>Evaluate Groups</small></h5>
<ul>
<li>
...
<?php
 ...
 $sqlcounNAme = "SELECT count(assign_projects.grp_id) as total FROM assign_projects
...
<div class="card-block">
<h5>Evaluate <small> Completed Groups </small></h5>
<ul>
<li>
...
<?php
 ...
 where assign_projects.e_id=$eid  and groupleader.projEvaluate ='yes'
...
<?php
 ...
 $sqlcounNAme = "SELECT count(distinct section) as total FROM assign_projects
 where e_id=$eid  ";
...
<i class="icofont icofont-download-alt f-18" onclick="downloadFile('.$clr.$rw['path'].$clr.')"></i><i  style="color:red;margin-left:20px;" class="ion-android-close f-20" onclick="dellfile('.$clr.$rw['path'].$clr.')" ></i>
</div> 
</li>';
...
<div class="card">
<div class="card-block">
<h5 >Assigned Projects Details | </h5><span>Computer Science <h5> | </h5> F-19  </span> <h5 style="padding-left:8px;"> | </h5> <span style="color:orange;"><i> Level 2 </i><span>
<button disabled type="button" class="btn btn-warning   float-right btn-mini btn-skew" data-toggle="modal" data-target="#Modal-tab">Comming Soon</button>
<button disabled type="button" style="margin-right:3px;" class="btn btn-info   float-right btn-mini btn-skew" data-toggle="modal" data-target="#Modal-deadone">Comming Soon</button>
</div>
<div class="card-block">
